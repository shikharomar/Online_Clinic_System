				...
				<table class="table table-bordered table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td><a
								href="IntimatePatients.jsp?doctorID=<%=db.getDoctorID()%>&stringLeaveFrom=<%=lb.getLeaveFrom()%>&stringLeaveTo=<%=lb.getLeaveTo()%>">View Patients</a></td>
						</tr>
						<%
							}
						%>
